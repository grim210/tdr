...
bool DirectDrawTexture::isValid(void)
{
    return m_ready;
}

std::string DirectDrawTexture::getTextureType(void)
{
    switch (m_level) {
    case DXT1:
...
uint32_t DirectDrawTexture::getMipMapCount(void)
{
    return m_mmcount;
}

uint32_t DirectDrawTexture::getWidth(void)
{
    return m_width;
}

uint32_t DirectDrawTexture::getHeight(void)
{
    return m_height;
}

std::vector<char> DirectDrawTexture::getPixelData(void)
{
    std::vector<char> ret;
