...
DELSTRING="aclocal.m4 ar-lib autom4te.cache compile confdefs.h config.h config.h.in config.guess config.log config.status config.sub configure depcomp install-sh libtool ltmain.sh Makefile Makefile.in missing stamp-h1"
RM="rm -rf"
